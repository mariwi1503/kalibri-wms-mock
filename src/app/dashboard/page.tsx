...
export default function DashboardPage() {
  ...
  const availableWarehouses = warehouses.filter((w: { status: string; }) => w.status === 'available').length;
  const rentedWarehouses = warehouses.filter((w: { status: string; }) => w.status === 'rented').length;
  const activeRentals = rentals.filter((r: { status: string; }) => r.status === 'active').length;
  const totalRevenue = rentals
    .filter((r: { status: string; }) => r.status === 'active')
    .reduce((sum: number, r: { monthly_price: any; }) => sum + parseFloat(r.monthly_price || 0), 0);
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {user.type === 'admin' 
                ...
                : 'Temukan gudang terbaik untuk kebutuhan bisnis Anda'
              }
            </p>
          </div>
          <div className="hidden sm:block">
            <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-green-500 rounded-2xl flex items-center justify-center">
      ...
      {user.type === 'admin' ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{availableWarehouses}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{rentedWarehouses}</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Penyewaan Aktif</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Gudang Tersedia</p>
                <p className="text-2xl font-bold text-green-600">{warehouses.length}</p>
              </div>
              <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
                <Warehouse className="w-6 h-6 text-green-600" />
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Total Biaya/Bulan</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <a
              href={user.type === 'admin' ? '/dashboard/warehouses' : '/dashboard/search'}
          ...
          <div className="space-y-4">
            {warehousesLoading ? (
              ...
              warehouses.slice(0, 3).map((warehouse: { id: Key | null | undefined; name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; city: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; size_sqm: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; price_per_month: any; }) => (
                <div key={warehouse.id} className="flex items-center space-x-4 p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-gray-900">{formatPrice(warehouse.price_per_month)}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <a
              href={user.type === 'admin' ? '/dashboard/rentals' : '/dashboard/my-rentals'}
              className="text-blue-600 hover:text-blue-700 text-sm font-medium"
            >
              Lihat Semua
            </a>
          ...
          <div className="space-y-4">
            {rentalsLoading ? (
              ...
              rentals.slice(0, 3).map((rental: { id: Key | null | undefined; warehouse_name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; start_date: string | number | Date; status: string; monthly_price: any; }) => (
                <div key={rental.id} className="flex items-center space-x-4 p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
                  <div className="w-12 h-12 bg-linear-to-br from-green-100 to-blue-100 rounded-lg flex items-center justify-center">
                    <FileText className="w-6 h-6 text-green-600" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-medium text-gray-900 truncate">{rental.warehouse_name}</h3>
                    <div className="flex items-center text-sm text-gray-500 mt-1">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        {rental.status === 'active' ? 'Aktif' :
                         rental.status === 'pending' ? 'Pending' : 'Selesai'}
                      </span>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-gray-900">{formatPrice(rental.monthly_price)}</p>
                    <p className="text-xs text-gray-500">/bulan</p>
                  </div>
                </div>
              ))
          ...
          {user.type === 'admin' ? (
            <>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Tambah Gudang</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Kelola Gudang</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Lihat Penyewaan</span>
              </a>
            ...
            <>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Cari Gudang</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Penyewaan Saya</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Jelajahi</span>
              </a>
